...
@property (nonatomic, assign) BOOL useSpeakerInVoiceOver;
...
- (void)setLengthWithTagName:(NSString *)pTagName length:(NSInteger)pLength webView:(UIWebView *)pWebView __attribute__((deprecated)); // 태그이름 길이 설정
...
- (void)setSupportLinkage:(BOOL)pYesOrNO __attribute__((deprecated));                 // 연동모드
